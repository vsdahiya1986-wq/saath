...
export const ACTIVITIES: ActivityInfo[] = [
  ...
  },
  {
    ...
    slug: 'saah_pat',
    icon: 'leaf',
    labelKey: 'activity.saah_pat',
    domainKey: 'domain.attention',
    introKey: 'play.saah_pat.intro',
    cstSession: 'CST Session 6 · Attention & Concentration',
    blurb: 'Find the two-leaves-and-a-bud sprigs among the others.',
  },
  {
    activity: 'apon_mukh',
    slug: 'apon_mukh',
    icon: 'cardback',
    labelKey: 'activity.apon_mukh',
    domainKey: 'domain.memory',
    introKey: 'play.apon_mukh.intro',
    cstSession: 'CST Session 12 · Faces & Names',
    blurb: 'Turn over the cards and find the pairs of familiar faces.',
  },
  {
    activity: 'together',
    slug: 'together',
